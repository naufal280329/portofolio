   ...
   <a href="img/cv_naufal.pdf.pdf" class="btn">Unduh CV</a>
    ...
    <section id="skills" class="section skills">
        ...
        <div class="skills-grid">
            <div class="skill-card">
                <h3>Mikrotik</h3>
                <p>Configuring router, setup VLAN and hotspot, blocking web, troubleshooting network issues, manajement bandwinth for network enterprise </p>
            </div>
            <div class="skill-card">
                <h3>Fiber Optic</h3>
                <p>Splicing and installation techniques, fiber optic cable installation, OTDR measurement</p>
            </div>
            <div class="skill-card">
                <h3>Server</h3>
                <p>experience in setting up and maintaining Linux/Windows servers, virtualization, system monitoring, and data backup
</p>
            </div>
            <div class="skill-card">
                <h3>Electro</h3>
                <p>skills in microcontroller programming and IoT system development for electronics projects</p>
            </div>
        </div>
    </section>
    ...
    <section id="projects" class="section projects">
        ...
        <div class="projects-grid">
            ...
            <div class="project-card">
                <h3>IOT SMART MONITORING QUALITY FRUIT </h3>
            ...
            <div class="project-card">
                <h3>INTALASI AND CONFIGURATON PPPOE</h3>
            ...
            <div class="project-card">
                <h3>SERTIFIKAT WEBINAR IOT TELKOM</h3>
